...
cdef extern void photochemvars_particle_radius_get_size(void *ptr, int *dim1, int *dim2)
cdef extern void photochemvars_particle_radius_get(void *ptr, int *dim1, int *dim2, double *arr)
cdef extern void photochemvars_particle_radius_set(void *ptr, int *dim1, int *dim2, double *arr)
